...
$getdata = $conn->query("select * from `state` where `status` = 1 && dstatus = 0 ".$searchvar."  order by id desc LIMIT $start_from, $per_page_record ");
// print_r($getdata);die;

$chekdata =$conn->query("select * from `state` where `status` = 1 && dstatus = 0  ".$searchvar."");  
                ...
                <table class="table table-bordered">
                  ...
                  if($getdata->num_rows>0){
                    while($file = $getdata->fetch_assoc()){
                      $Checkcountry = $conn->query("select * from country where id='".$file['country_id']."'");
                    ...
                    <tr>
                      ...
                      <?php echo $statusarr [$file['status']] ; ?>
                        ...
                        <td>
                        <a href="<?php echo SITEADMINURL;?>state/edit.php?id=<?php echo $file['id'];?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
